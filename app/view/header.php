...
<head>
    ...
    <link rel="shortcut icon" type="image/png" href="<?php echo _SERVER_ . _ICON_;?>">
    ...
    <link rel="stylesheet" href="<?php echo _SERVER_ . _VIEW_STYLES_;?>css/propios.css">

    <!-- Start datatable css -->
    <link rel="stylesheet" type="text/css" href="<?php echo _SERVER_ . _VIEW_STYLES_;?>datatable/jquery.dataTables.css">
    <link rel="stylesheet" type="text/css" href="<?php echo _SERVER_ . _VIEW_STYLES_;?>datatable/dataTables.bootstrap4.min.css">
    <link rel="stylesheet" type="text/css" href="<?php echo _SERVER_ . _VIEW_STYLES_;?>datatable/responsive.bootstrap.min.css">
    <link rel="stylesheet" type="text/css" href="<?php echo _SERVER_ . _VIEW_STYLES_;?>datatable/responsive.jqueryui.min.css">
